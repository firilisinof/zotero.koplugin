...
step("20-metadata-collections", function()
    ...
    assert(browser.item_group[2].entry.on_device)
    assert(browser.item_group[3].entry.collection)
end)

local DocSettings = require("docsettings")
local ReaderUI = require("apps/reader/readerui")
local local_pdf, local_epub, pdf_contents, epub_contents, offline_http
...
local function advance()
    ...
    local delay = current.name == "23-offline-pdf" and 3.5 or current.name == "10-progress" and 1.5 or 0.1
